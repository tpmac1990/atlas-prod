...
import InfinitySelectArea from './InfinitySelectArea'

const ServerSideInfinitySelect = props => {
    ...
    useEffect(() => {
        loading && dispatch(getInfinityDropdownData({name,model,key,label,search,offset,limit,clientmax},endpoint))
    },[loading])
    ...
    return <InfinitySelectArea name={name} scrollHandler={scrollHandler} options={data} />

}

export default ServerSideInfinitySelect;
