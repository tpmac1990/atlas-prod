...
const ClientSideInfinitySelect = props => {
    ...
    return <InfinitySelectArea scrollHandler={scrollHandler} options={slicedOptions} name={name} />

}

export default ClientSideInfinitySelect;
