    ...
    if ( value === null ){
        ...
        return (
            <div className='edit-page'>
                ...
                <form>
                    <ItemsManyDropdownAddMulti is_large={is_large} header='Parents' datagroup='holders' values={value.parent_company} has_input={true} columns={relatedMulti} dropdown_dict={parentSelect} />
                    <ItemsManyDropdownAddMulti is_large={is_large} header='Subsidiaries' datagroup='holders' values={value.subsidiaries} has_input={true} columns={relatedMulti} dropdown_dict={subsidiarySelect} />
