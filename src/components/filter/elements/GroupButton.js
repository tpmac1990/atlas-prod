...
function GroupButton(props) { 
    ...
    let style = category == 'a' ? `filter-grp-btn-pri btn-c2 ${btnStyle}` : `filter-grp-btn-sec btn-c3 ${btnStyle}`
    // add extra styling if the buttons sub area is open
    style = open ? `${style} btn-act-c1` : style
